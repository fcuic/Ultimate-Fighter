------------------------------------------------------------------------
SF Toontime Extras! - Version 1.0
------------------------------------------------------------------------

The following fonts are included:

 - SF Toontime B
 - SF Toontime B Italic
 - SF Toontime Blotch Bold
 - SF Toontime Blotch Bold Italic
 - SF Toontime Extended
 - SF Toontime Extended Bold
 - SF Toontime Extended Bold Italic
 - SF Toontime Extended Italic

------------------------------------------------------------------------
SF Toontime Extras! - Version 1.0 - Features
------------------------------------------------------------------------
